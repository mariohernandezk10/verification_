...
const prefix = PREFIX || "[prefix]svm";
const guild_id = GUILD_ID || process.env.GUILD_ID;
const verified_role_id = ROLE_ID || process.env.ROLE_ID;
const verification_channel_id = CHANNEL_ID || process.env.CHANNEL_ID;
